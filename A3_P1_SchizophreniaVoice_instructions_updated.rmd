...
pitch_data <- pitch_data %>% ppurrr::map_df(read_pitch)
...
byStudyPitch <- lmer(pitchScaled ~ 0 + study + diagnosis:study + (1 | uID), data=data)
...
modelPause <- lmer(pauseDurationScaled ~ 1 + diagnosis + (1 + study | uID) , data = data)
summary(modelPause)

modelPitch <- lmer(pitchScaled ~ 1 + diagnosis + (1 + study | uID) , data = data)
summary(modelPitch)

modelSpeechrate <- lmer(speechrateScaled ~ 1 + diagnosis + (1 + study | uID) , data = data)
summary(modelSpeechrate)

modelPropSpokenTime <- lmer(propSpokenTime ~ 1 + diagnosis + (1 + study | uID) , data = data)
